/*
 * GAME SCENE
 * Copyright © 2021+ Marcelo LÛpez de Lerma
...
int main ()
{
    // Es necesario habilitar un backend gr√°fico antes de nada:
...
// El linker tiende a eliminar c√≥digo que cree que no se usa y, cuando se termina usando, lo echa en
// falta provocando errores. Dejar estas referencias aqu√≠ por el momento para evitar esos problemas:
